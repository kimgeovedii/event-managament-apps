...
const colorClasses = {
  pink: {
    ...
    shadow:
      "hover:shadow-[0_10px_40px_-10px_rgba(238,43,140,0.4)] dark:hover:shadow-[0_10px_40px_-10px_rgba(255,0,255,0.4)]",
  },
  cyan: {
    badge: "bg-[#00bcd4] dark:bg-[#00FFFF] text-white dark:text-black",
    shadow:
      "hover:shadow-[0_10px_40px_-10px_rgba(0,188,212,0.4)] dark:hover:shadow-[0_10px_40px_-10px_rgba(0,255,255,0.4)]",
  },
  purple: {
    badge: "bg-[#9c27b0] dark:bg-[#B026FF] text-white",
    shadow:
      "hover:shadow-[0_10px_40px_-10px_rgba(156,39,176,0.4)] dark:hover:shadow-[0_10px_40px_-10px_rgba(176,38,255,0.4)]",
  },
  green: {
  ...
  lime: {
    ...
    shadow:
      "hover:shadow-[0_10px_40px_-10px_rgba(132,204,22,0.4)] dark:hover:shadow-[0_10px_40px_-10px_rgba(204,255,0,0.4)]",
  },
};
...
const EventCard: React.FC<EventCardProps> = ({ event }) => {
  ...
  const resolvedPrice = (() => {
    ...
    if (event.ticketTypes && Array.isArray(event.ticketTypes)) {
      const prices = event.ticketTypes.map((t: any) =>
          ...
          <button
            ...
            className={`p-1 md:p-2 rounded-full hover:bg-gray-100 dark:hover:bg-white/10 transition-colors ${
              isFavorite
                ...
                : "text-gray-400 hover:text-[#ee2b8c] dark:hover:text-[#FF00FF]"
            }`}
          >
